...
package com.zlk.bigdemo.android.camera.gallery;
...
public abstract class BaseImageList implements IImageList {
    ...
    public BaseImageList(ContentResolver resolver, Uri uri, int sort,
        ...
        if (mCursor == null) {
        	LogUtil.w(TAG, "createCursor returns null.");
        }
    ...
    public void close() {
        try {
        	...
        	LogUtil.e(TAG, "Caught exception while deactivating cursor.", e);
        }
    ...
    public Uri contentUri(long id) {
        ...
        try {
            ...
            if (existingId != id) LogUtil.e(TAG, "id mismatch");
            return mBaseUri;
    ...
    public IImage getImageForUri(Uri uri) {
        ...
        try {
        	...
        	LogUtil.i(TAG, "fail to get id in: " + uri);
            return null;
        }
