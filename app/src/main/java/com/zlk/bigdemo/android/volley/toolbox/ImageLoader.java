...
public class ImageLoader {
    ...
    public ImageContainer get(final String requestUrl, final ImageListener imageListener,
            final int maxWidth, int maxHeight) {
        throwIfNotOnMainThread();
        Bitmap	cachedBitmap = mCache.getBitmap(requestUrl);
        ...
        ImageContainer imageContainer =
                new ImageContainer(null, requestUrl, requestUrl, imageListener);
        ...
        Request<?> newRequest =
            new ImageRequest(requestUrl, new Listener<Bitmap>() {
                ...
                public void onResponse(Bitmap response) {
                    onGetImageSuccess(requestUrl, response,maxWidth);
                }
            }, maxWidth, maxHeight,
        ...
        mInFlightRequests.put(requestUrl,
     ...
     */
    private void onGetImageSuccess(String cacheKey, Bitmap response, int width) {
        // cache the image that was fetched.
//    	if(isLocal){
//    		 mCache.putBitmap(cacheKey+width, response);
//    	}else{
